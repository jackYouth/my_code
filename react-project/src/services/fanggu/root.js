...
const Routes = () => (
  <Router history={ browserHistory } >
    <Route path='/fanggu' component={ require('react-router?name=root!./components/root') } >
      <IndexRoute component={require('react-router?name=app!./containers/app') } />
      <Route path='chooseDistrict' component={ require('react-router?name=chooseDistrict!./containers/chooseDistrict') } />
