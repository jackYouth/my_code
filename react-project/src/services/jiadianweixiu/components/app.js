  ...
  if (listData) {
    ...
    return (
      <div className='listMain'>
        <UserCenter categoryCode='jiadianweixiu' />
        <div className='headerWrap'>
          <div className='header_l' />
          <div className='header_c' onClick={ () =>
            Mask(
              <SlidePage target='left' showClose={ false }>
                <CitySearch localCity='上海' api='/basis/v1/jiadianweixiu/zmn/cities' handleCityData={ result => getListDataHandle(result) } />
              </SlidePage>
        ...
        </div>
        {
          (listData && listData.length === 0) && (
            <div className='kongWrap'>
              ...
              <div className='tips'>该城市尚未提供家电维修服务敬请期待</div>
            </div>
          )
        }
      </div>
